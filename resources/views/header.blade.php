            ...
            <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                ...
                <div class="mx-auto">
                    <div class="flex space-x-4">
                        ...
                        <!-- Active: 'text-sky-600 dark:text-white', Inactive 'text-slate-400' -->
                        <a href="{{route('blog')}}"
                           class="px-3 py-2 text-sm rounded-md hover:text-sky-600 dark:hover:text-white {{request()->routeIs('blog')? 'font-semibold  text-sky-600 dark:text-white':'text-slate-400 font-medium '}}">
                            Blog
                        </a>
                        <!-- Active: 'text-sky-600 dark:text-white', Inactive 'text-slate-400' -->
                        <a href="{{route('about')}}"
